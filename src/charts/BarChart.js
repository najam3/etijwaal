...
const BarChart = () => {
  ...
  const acquisitionData =  selected === 'All Time' ? [400, 300, 600, 140, 133, 117] : selected === 'This Year' ? [400, 600, 355, 475, 260, 566] : selected === 'This Week' ? [400, 300, 540, 240, 300, 143] : ''
    ...
    datasets: [
      {
        ...
        backgroundColor: ["gray", "#ED8936", "gray", "#ED8936", "gray", "#ED8936"],
  ...
  return (
    <Box flex="2" my={{  base:4, md: 4, lg: 10}} maxWidth="100%" shadow={'xl'} borderRadius={10} p={5}>   
